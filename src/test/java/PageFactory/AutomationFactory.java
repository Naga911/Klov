...
public class AutomationFactory {
    ...
    @AndroidFindBy(id = "xunison.com.smarthomeapp:id/automation_title_edit_text")
    public WebElement AutomationTitle;

    @AndroidFindBy(id = "xunison.com.smarthomeapp:id/button_save_automation")
    ...
    @AndroidFindBy(id = "xunison.com.smarthomeapp:id/time_range_checkbox")
    ...
    @AndroidFindBy(xpath = "//*[@text='Edit automation']")
    public WebElement BottomEdit;

    @AndroidFindBy(xpath = "//*[@text='Delete automations']")
